...
func ChangeUnicode(unicode string) string {
	...
	unicode = strings.ReplaceAll(unicode, "人", "ㅅ")
	unicode = strings.ReplaceAll(unicode, "ŭ", "ㅐ")
	unicode = strings.ReplaceAll(unicode, "Ð", "ㅇ")
	//unicode = strings.ReplaceAll(unicode, "o", "ㅇ")
...
func RemoveDomain(input string) string {
	...
	input = strings.ReplaceAll(input, "x.com", "")
	...
	input = strings.ReplaceAll(input, "?si=", "")
	return input
}
...
func KoToEnglish(input string) string {
	...
	input = strings.ReplaceAll(input, "ㅠ", "b")
	input = strings.ReplaceAll(input, "ㅊ", "c")
	input = strings.ReplaceAll(input, "ㅇ", "d")
	input = strings.ReplaceAll(input, "ㄷ", "e")
	input = strings.ReplaceAll(input, "ㄹ", "f")
	input = strings.ReplaceAll(input, "ㅎ", "g")
	input = strings.ReplaceAll(input, "ㅗ", "h")
	input = strings.ReplaceAll(input, "ㅑ", "i")
	input = strings.ReplaceAll(input, "ㅓ", "j")
	input = strings.ReplaceAll(input, "ㅏ", "k")
	input = strings.ReplaceAll(input, "ㅣ", "l")
	input = strings.ReplaceAll(input, "ㅡ", "m")
	input = strings.ReplaceAll(input, "ㅜ", "n")
	input = strings.ReplaceAll(input, "ㅐ", "o")
	input = strings.ReplaceAll(input, "ㅔ", "p")
	input = strings.ReplaceAll(input, "ㅂ", "q")
	input = strings.ReplaceAll(input, "ㄱ", "r")
	input = strings.ReplaceAll(input, "ㄴ", "s")
	input = strings.ReplaceAll(input, "ㅅ", "t")
	input = strings.ReplaceAll(input, "ㅕ", "u")
	input = strings.ReplaceAll(input, "ㅍ", "v")
	input = strings.ReplaceAll(input, "ㅈ", "w")
...
func EnglishToKo(input string) string {
	...
	input = strings.ReplaceAll(input, "b", "ㅠㅠ")
