...
var General = []string{"닥쳐", "닭쳐", "닥치라", "아가리해", "dog새", "개ㅐ색", "개같", "개가튼", "개쉑", "개스키", "개세끼", "개색히", "개가뇬", "개새기", "개쌔기", "개쌔끼",
	...
	"게좆", "계같은뇬", "계뇬", "계뇽", "쉬댕", "쉬뎅", "개생끼", "tq", "qt", "썅", "씨앙", "씨양", "샤앙", "쌰앙", "좆", "촟", "조까", "좈", "쫒", "졷", "좃", "줮",
...
var Sexual = []string{
	...
	"배위에싸죠", "몸의대화", "섹할", "섹해", "크리토리스", "클리토리스", "페니스", "애널",
	"젖까", "젖가튼", "젖나", "젖만", "ja위", "자위", "고자새끼", "고츄", "꺼추", "꼬추", "헤으응", "헤응", "헤윾", "헤윽", "하앙", "하윾", "하윽", "흐윽", "흐윾", "흐읏", "하읏", "하아앙",
}
...
var Politics = []string{
	...
	"반인반신", "데미갓", "박정희", "간철수", "가카", "이명박근혜", "다스는누구겁니까",
}
...
var Japanese = []string{"肉便器", "糞野郎", "バカ野郎", "腐れ外道", "部落民", "中出し", "強姦",
	"特定アジア", "人非人", "鬼畜", "負け犬", "支那", "トルコ風呂", "淫売", "未開人",
}

var Chinese = []string{"G巴", "Ｇ巴", "G叭", "Ｇ叭", "G芭", "Ｇ芭", "G掰", "Ｇ掰", "g點", "MM屄", "mm美圖", "qvod成人", "sex聊天室", "SM後庭器具", "SM援交", "SM舔穴", "sm調教",
